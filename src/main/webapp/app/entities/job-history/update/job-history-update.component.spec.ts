...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 16683 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 6952 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 14291 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 22904 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 28861 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 16166 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 14555 };
      jobHistory.job = job;
      const department: IDepartment = { id: 8202 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 4107 };
      jobHistory.employee = employee;
