...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 13083 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 9933 }];
    ...
    it('Should call Employee query and add missing value', () => {
      ...
      const employeeCollection: IEmployee[] = [{ id: 2297 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 25092 };
      job.tasks = [task];
      const employee: IEmployee = { id: 31394 };
      job.employee = employee;
